...
fun solve ([], score) = score
  ...
  if x = "A X" then solve(strats, score + 3)
  else if x = "A Y" then solve(strats, score + 4)
  else if x = "A Z" then solve(strats, score + 8)
  else if x = "B X" then solve(strats, score + 1)
  else if x = "B Y" then solve(strats, score + 5)
  else if x = "B Z" then solve(strats, score + 9)
  else if x = "C X" then solve(strats, score + 2)
  else if x = "C Y" then solve(strats, score + 6)
  else if x = "C Z" then solve(strats, score + 7)
  else raise Domain;
